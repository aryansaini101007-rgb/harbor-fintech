        ...
        <div className="flex flex-col md:gap-3 w-full">
          ...
          <div className="flex items-center justify-between h-14 w-full gap-4">
            ...
            <div className="hidden md:flex items-center gap-4 shrink-0">
              ...
              <button className="px-6 py-2.5 bg-gradient-to-r from-[#2563eb] to-[#6d4aff] hover:from-[#1d4ed8] hover:to-[#5b21b6] text-white text-sm font-medium rounded-full transition-all duration-300 shadow-md hover:shadow-lg hover:scale-[1.02] active:scale-95 flex items-center gap-2 whitespace-nowrap">
                <span>Apply Now</span>
                <span>→</span>
              </button>
            </div>
